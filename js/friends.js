    ...
    $.ajax({
        ...
        success: function(response){
            ...
            if (options.pageId === "profile") {
                ...
                $("a#btn-friend-action").removeClass("red yellow green").addClass('green').html("<i class=\"iconfont icofont-plus px-1\"></i>" + strings.sz_action_add_to_friends);
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            if (options.pageId === "profile") {
                ...
                $("a#btn-friend-action").removeClass("red yellow green").addClass('yellow').html("<i class=\"iconfont icofont-not-allowed px-1\"></i>" + strings.sz_action_cancel_friends_request);
